public class Recursividade {
    ...
    // Verificar se o dividendo é 0
    // Realizar a divisão usando subtrações sucessivas
    int divisao(int a, int b) {
       if (b == 0){
            System.out.println("Ta maluco, quer colocar fogo no computador?");
            return 0;
       } if(a < b) {
           return 0;
       }
       ...
       // throw new UnsupportedOperationException("Não desenvolvida ainda.");
    }
